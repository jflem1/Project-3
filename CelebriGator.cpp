...
void CelebriGator() {
    ...
    while (selection != -1) {
        ...
        if (selection == 1) { //Bestfriend Calculation
            string name;
            cout << "Please enter actor/actresses name: "<< endl;
            ...
            if (temp == -1){
                cout<< endl;
                cout<< "This actor/actress was not found in the data base! Try Again Please" << endl;
                cout<< endl;
                continue;
            }
            ...
            string name1, name2;
            cout << "Please enter name of first actor/actress: "<< endl;
            ...
            cout << "Please enter name of second actor/actress: "<< endl;
            getline(cin, name2);
            ...
            // if either actor/actress is not part of the data base the program will go back to the selection menu
            ...
            if (graphDistances[index2] == INT16_MAX) //INT_MAX represents no connection between actors
        ...
        cout << "Enter -1 to STOP or 1 to CONTINUE: "<< endl;
        cin >> selection;
    }
